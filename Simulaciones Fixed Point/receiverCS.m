function recived_bits=receiverCS(x,Fs_x,Fs_CS,Fs,A,offset,D,Comb,int_fp,dec_fp)
...
indices_of_blocks=DetectionModule(x_CS,D,normc(A),numberActiveBlocks,int_fp,dec_fp); 
...
recived_symbols=ValuesEstimation(x_CS,A,indices_of_samples,int_fp,dec_fp);
